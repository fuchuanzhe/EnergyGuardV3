...
public class PersonaModel
{
    ...
    private EnergyUsageModel _energyUsageModel;
    ...
    public PersonaModel(CpuInfo cpuInfo, PersonaFileService personaFileService, ProcessTrackerInfo processTrackerInfo, EnergyUsageModel energyUsageModel)
    {
    ...
    public async Task<bool> EnablePersona(string personaName)
    {
        ...
        if (index != -1)
        {
            ...
            await _energyUsageModel.Save();
            // Delay 10 minutes before applying persona to calculate the reference power usage.
            await Task.Delay(TimeSpan.FromMinutes(10));
            _energyUsageModel.RecordCostSavedRef(DateTime.Now);
    ...
    public bool DisableEnabledPersona()
    {
        if (PersonaEnabled != null)
        {
            ...
            _energyUsageModel.ClearCostSavedRef();
