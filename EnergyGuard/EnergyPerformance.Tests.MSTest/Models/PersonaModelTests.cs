...
public class PersonaModelTests
{
    ...
    private static ProcessTrackerInfo _processTrackerInfo;
    ...
    public static void ClassInit(TestContext context)
    {
        ...
        _processTrackerInfo = new ProcessTrackerInfo();
    ...
    {
        return new PersonaModel(new CpuInfo(), _personaFileService, _processTrackerInfo, _energyUsageModel);
    }
