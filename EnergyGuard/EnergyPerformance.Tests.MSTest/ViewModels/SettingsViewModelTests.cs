...
public class SettingsViewModelTests
{
    ...
    {
        return new EnergyUsageModel(_carbonIntensityInfo.Object, _energyRateInfo.Object, _databaseService.Object, new MediatorService());
    }
    ...
    public SettingsViewModel GetViewModel()
    {
        ...
        var viewModel = new SettingsViewModel(themeService, cpuInfo, localSettingsService, model, mediatorService, companyService);
        return viewModel;
    }
